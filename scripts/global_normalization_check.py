...
def plot_hist_mean(fits, key, title, xlabel, args) -> None:
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig(f"gn/{args.concatenation}-{args.data_mc_mode}-{key}.png")
    plt.savefig(f"gn/{args.concatenation}-{args.data_mc_mode}-{key}.pdf")
...
if __name__ == "__main__":
    ...
    model.add_argument(
        "--concatenation", default="detector",
